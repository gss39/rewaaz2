                        ...
                        <div class="card card-body">
                          <div class="col-md-12">
                            <label for="validationDefault01" style=" font-size: 16px;  color:#212529;  color: #747474 "
                              class="form-label"> <b style=" font-weight: normal; color: #919191; "> UPI ID :
                              </b></label>
                            <input type="text" class="form-control" placeholder="Enter UPI ID..."
                              id="validationDefault01" required></input>
                    ...
                    <td>
                      ...
                      <div class="collapse" id="collapseExample2">
                        <div style=" padding: 10px; " class="row g-3">
                          ...
                          <div class="col-sm-12">
                            <label for="validationDefault01" style=" font-weight: normal;  " class="form-label">Card
                              number :</label>
                            <input type="text" class="form-control" placeholder="Enter Card Number..."
                              id="validationDefault01" required>
                          </div>
                          <div class="col-sm-12">
                            <label for="validationDefault02" style="font-weight: normal; " class="form-label">Enter Name
                              On Card :</label>
                          ...
                          <div class="col-sm-6">
                            <label for="validationDefault03" style=" font-weight: normal; " class="form-label">MM
                              :</label>
                            <input type="text" class="form-control" placeholder="Enter MM..." id="validationDefault03"
                              required>
                          </div>
                          <div class="col-sm-6">
                            <label for="validationDefault03" style=" font-weight: normal;" class="form-label">YY
                              :</label>
                            <input type="text" class="form-control" placeholder="Enter YY..." id="validationDefault03"
                              required>
                          </div>
                          <div class="col-sm-12">
                            <label for="validationDefault02" style="font-weight: normal;" class="form-label">CVV
                              :</label>
                            <input type="text" class="form-control" placeholder="Enter CVV..." id="validationDefault02"
                              required>
                          </div>
    ...
    <div class="col-sm-4">
      ...
      <div class="card" id="cart_sidebar" style=" padding: 15px; ">
        ...
        <div class="d-grid gap-2">
          <button class="btn btn-primary" style="font-weight: 500; color: white;  " type="button"> <a
              style="color: white;  " href="order_summary.php">proceed to chack out</a> </button>
          <a href="order_summary.php"></a>
        </div>
        <!-- end row -->
