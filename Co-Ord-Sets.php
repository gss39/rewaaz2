             ...
             -->
                ...
                <div class="product-main">
                    ...
                    <div id="search_products" class="product-grid">
                        ...
                        // 
                        // SQL QUERY 
                        $query = "SELECT * FROM `products` WHERE catg = 'Co-Ord-Sets' LIMIT $limit  OFFSET $offset ";
                ...
                $query1 = "SELECT * FROM `products` WHERE catg = 'Co-Ord-Sets' ";
                ...
                if (mysqli_num_rows($result1) > 0) {
                    ...
                    <a href="Co-Ord-Sets.php?page=' . $preious_page . '">&laquo;</a>';
                    for ($i = 1; $i <= $total_page; $i++) {

                        echo '<a href="Co-Ord-Sets.php?page=' . $i . '">' . $i . '</a>';

                    }
                    echo '<a href="Co-Ord-Sets.php?page=' . $next_page . '">&raquo;</a></div>';
                }
