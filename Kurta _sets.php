             ...
             -->
                ...
                <div class="product-main">
                    ...
                    <div id="search_products" class="product-grid">
                        ...
                        // 
                        // SQL QUERY 
                        $query = "SELECT * FROM `products` WHERE catg = 'Kurta sets' LIMIT $limit  OFFSET $offset ";
                ...
                $query1 = "SELECT * FROM `products` WHERE catg = 'Kurta sets'";
                ...
                if (mysqli_num_rows($result1) > 0) {
                    ...
                    <a href="Kurta _sets.php?page=' . $preious_page . '">&laquo;</a>';
                    for ($i = 1; $i <= $total_page; $i++) {

                        echo '<a href="Kurta _sets.php?page=' . $i . '">' . $i . '</a>';
